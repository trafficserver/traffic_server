...
# ==============================================================================
URL_DO_SEU_SITE = "https://gravacaodevinheta.com.br"  # Ex: "https://www.meusite.com.br"
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            event_data = {
                ...
                "events": [{"name": "page_view", "params": { "page_location": URL_DO_SEU_SITE, "page_title": NOME_DO_SEU_SITE, "engagement_time_msec": engagement_time, "geo_id": city, "city": city, "region": "BR"}}]
            }
